...
- 74 passing credential-free tests.
...
The system currently passes three of eleven release gates: current catalogue dates,
official-source pricing verification, and exact artifact/catalogue/policy provenance.
It fails closed on the remaining eight:
...
7. a precise Switchyard build has not been pinned and qualified; and
8. a direct-provider gateway bypass has not been configured.
